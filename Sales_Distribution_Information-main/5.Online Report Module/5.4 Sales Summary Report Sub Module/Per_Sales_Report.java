import java.io.*;
import java.sql.*;
public class Per_Sales_Report
{
    Connection con;
    ResultSet rs;
    Per_Sales_Report(String start_date, String end_date)
    {
        try{
            ...
            bw.write("<center><h1>Products Sales Transaction Report (Periodical)</h1></center>");
    ...
    public static void main(String args[]){
        new Per_Sales_Report("16-DEC-2022", "31-DEC-2022");
    }
    void Connection_method(String sdate, String edate) {
        try {
            ...
            String qry = "Select s.sales_billno, s.sales_date, w.wholeseller_id, w.wholeseller_name, w.city, s.product_id, p.product_name, p.packaging_unit, s.sales_qty, s.sales_rate, s.gst_in_per, s.add_amount, s.add_info from Products_Sales s, Wholesellers_Master w, Products_Master p where s.wholeseller_id = w.wholeseller_id and s.product_id = p.product_id and s.sales_date between '"+ sdate +"' and '"+ edate +"' order by s.sales_date";
