import java.io.*;
import java.sql.*;
public class Products_InfoReport
{
    Connection con;
    ResultSet rs;
    Products_InfoReport()
    {
        try{
            BufferedWriter bw = new BufferedWriter(new FileWriter("InfoRep3.html"));
            bw.write("<html>");
            bw.write("<body>");
            bw.write("<center><h1>Samsung Electronics Limited</h1></center>");     
            bw.write("<center><h1>Products Information Report</h1></center>");
            ...
            rt.exec("Explorer InfoRep3.html");
        }
