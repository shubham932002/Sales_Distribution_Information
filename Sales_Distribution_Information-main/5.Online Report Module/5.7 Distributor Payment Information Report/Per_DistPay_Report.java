import java.io.*;
import java.sql.*;
public class Per_DistPay_Report
{
    Connection con;
    ResultSet rs;
    Per_DistPay_Report(String start_date, String end_date)
    {
        try{
            BufferedWriter bw = new BufferedWriter(new FileWriter("Pay2.html"));
            bw.write("<html>");
            bw.write("<body>");
            bw.write("<center><h1>Samsung Electronics Public Limited</h1></center>");     
            bw.write("<center><h1>Distributors Payment Received Transaction Report (Periodical)</h1></center>");
            ...
            bw.write("<th>Distributor Firm Name Name</th>");
            bw.write("<th>City</th>");
    ...
    public static void main(String args[]){
        new Per_DistPay_Report("16-DEC-2022", "31-DEC-2022");
    }
    void Connection_method(String sdate, String edate) {
        try {
            ...
            String qry = "Select p.dist_pay_recno, p.dist_pay_recdate, p.distributor_id, d.dist_firmname, d.city, p.rec_amount, p.dist_pay_mode_info from distributors_payment p, distributors_master d where p.distributor_id = d.distributor_id and p.dist_pay_recdate between '"+ sdate +"' and '"+ edate +"' order by p.dist_pay_recdate";
